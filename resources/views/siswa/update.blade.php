...
<div class="row">
    <div class="col-md-12">
      <div class="card shadow mb-4">
        ...
        @endif
        <div class="card-body">
            <form class="form-valide-with-icon needs-validation" action="{{route('siswa.update',$siswa->id_siswa)}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="mb-3 vertical-radius">
                    ...
                    <div class="input-group validate-username">
                        <input type="file" class="form-control br-style"
                            ...
                            @empty($siswa->foto_profile)
                            <p>Foto Profile tidak ada</p>
                        @else
                            <div class="mt-2" >
                                <small  >Foto lama:</small>
                                <img src="{{asset('storage/back/foto-profile/'.$siswa->foto_profile) }}" class="img-thumbnail img-preview" alt="Foto Pengguna" width="120px">
                            </div>
                        @endempty
                            @error('foto_profile')
            ...
            @enderror
              ...
              <div class="form-group col-md-12">
                ...
                <input type="text" class="form-control" name="name" id="inputEmail5"id="name" name="name" value="{{$siswa->name}}">
                @error('name')
                <div class="invalid-feedback">
                    {{$message}}
                </div>
            @enderror
              ...
              <div class="form-group col-md-12">
                ...
                <input type="email" class="form-control" name="email" id="inputEmail5" value="{{$siswa->email}}">
                @error('email')
                <div class="invalid-feedback">
                    {{$message}}
                </div>
            ...
            <div class="form-group col-md-12">
              ...
              <div class="form-group col-md-12">
                ...
                <input type="textarea" class="form-control" name="alamat" id="inputPassword5"  value="{{$siswa->alamat}}">
                @error('alamat')
                <div class="invalid-feedback">
                    {{$message}}
                </div>
            @enderror
              ...
              <div class="form-group col-md-12">
                ...
                <input type="number" class="form-control" name="telepon" id="inputPassword5"  value="{{$siswa->telepon}}">
                @error('email')
                <div class="invalid-feedback">
                    {{$message}}
                </div>
