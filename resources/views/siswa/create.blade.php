    ...
    <div class="col-md-12">
      <div class="card shadow mb-4">
        <div class="card-header">
          <strong class="card-title">Form Tambah Siswa</strong>
        </div>
        @if ($errors->any())
        <div class="my-3">
        ...
        @endif
        <div class="card-body">
            <form class="form-valide-with-icon needs-validation" action="{{route('siswa.store')}}" method="post" enctype="multipart/form-data">
                @csrf
