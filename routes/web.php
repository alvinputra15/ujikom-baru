...
use App\Http\Controllers\back\siswac;
...
Route::middleware(['auth'])->group(function(){
    ...
    Route::get('/siswa', [siswac::class, 'index'])->name('siswa.index');
    Route::get('/siswa/tambah', [siswac::class, 'create'])->name('siswa.tambah');
    Route::get('/siswa/edit/{id_siswa}', [kelasC::class, 'edit'])->name('siswa.edit');
    Route::post('/siswa/store', [siswac::class, 'store'])->name('siswa.store');
    Route::post('/siswa/update{id_siswa}', [siswac::class, 'update'])->name('siswa.update');
    Route::post('/siswa/delete', [siswac::class, 'delete'])->name('siswa.delete');
